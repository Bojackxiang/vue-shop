        ...
        <div class="content">
          ...
          <div class="item-total">
            <div class="phone-info clearfix">
              <div class="fl">{{product. me}} {{version==1?'6GB+64GB 全网通':'4GB+64GB 移动4G'}} 深灰色</div>
    ...
    addCart() {
      this.axios
        ...
        .then((res = { cartProductVoList: 0 }) => {
           ...
           * todo: 1: vuex 累加 ✅
           * todo: 2: 跳转到购物车 ✅
           * todo: 3: 加了购物车之后要看是不是已经登陆，如果没有登陆要跳转到登陆页面
           * note: 这里尽量用错误拦截的情况来处理
           * backend 是否成功的解析了cookie，如果是，那么返回成功，如果不是那么返回错误信息
           */
