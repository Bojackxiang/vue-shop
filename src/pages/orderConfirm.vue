        ...
        <div class="order-box">
          <div class="item-address">
            ...
            <div class="addr-list clearfix">
              ...
              >
                ...
                <div class="action">
                  <a href="javascript:;" class="fl" @click="removeAddress(index)">
          ...
          <div class="item-good">
            ...
            <ul>
              <li v-for="(item, index) in cartList" :key="index">
                ...
                <div class="good-quantity">{{item.quantity}}件</div>
                <div class="good-price">{{item.productPrice}}元</div>
          ...
          <div class="detail">
            <div class="item">
              ...
              <span class="item-val">{{itemTotalQuantity}}件</span>
            </div>
            <div class="item">
...
export default {
  ...
  data() {
    return {
      ...
      showEditModal: false, // => edtior modal
      showHintModal: false, // => hint modal
  ...
  methods: {
    ...
    getCartList() {
      ...
      this.axios.get("/carts").then(cartResp => {
        ...
        this.itemTotalQuantity = totalQuantity;
      });
    },
